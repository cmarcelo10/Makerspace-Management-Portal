  ...
  const fetchAPI = async () => {
    try {
      const [usersResponse, issuesResponse, equipmentResponse, bookingsResponse, requestsResponse] = await Promise.all([
        ...
        axios.get("http://localhost:8800/issues"),
        axios.get("http://localhost:8800/equipment"),
        axios.get("http://localhost:8800/bookings"),
        axios.get("http://localhost:8800/requests")
      ]);
