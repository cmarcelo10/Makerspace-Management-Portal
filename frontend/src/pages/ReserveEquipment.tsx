...
import { Button, Card, CardContent, Modal, Typography, Stack } from '@mui/material';

import Grid2 from '@mui/material/Grid2'; // Import Grid2 from MUI
import '../styles/reserve_equipment/local.css';
import NavBar from '../Components/NavBar.tsx';
import MainContainer from '../Components/MainContainer.tsx';
import { Fab, Tab, Tabs,   CardActionArea, CardActions, Accordion, ButtonGroup, CircularProgress, IconButton, TextField, Input } from '@mui/material';
